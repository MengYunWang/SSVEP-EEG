...
value = spcrv([times2save;squeeze(nanmean(x2y_d))-squeeze(nanmean(y2x_d))]); % smooth the line----function 'spcrv'
plot(value(1,:),value(2,:),'k','linewidth',3)
hold on;
value = spcrv([times2save;squeeze(nanmean(x2y_s))-squeeze(nanmean(y2x_s))]);
plot(value(1,:),value(2,:),':k','linewidth',3)
set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0.005 0.035],'ytick',0.01:0.01:0.05,'linewidth',3);
...
figure,clf
set (gcf,'color','w')
value = spcrv([times2save;squeeze(nanmean(x2y2))-squeeze(nanmean(y2x2))]);
plot(value(1,:),value(2,:),'color',[0.6 0.6 0.6],'linewidth',3)
hold on;
value = spcrv([times2save;squeeze(nanmean(x2y3))-squeeze(nanmean(y2x3))]);
plot(value(1,:),value(2,:),'r','linewidth',3)
hold on;
value = spcrv([times2save;squeeze(nanmean(x2y4))-squeeze(nanmean(y2x4))]);
plot(value(1,:),value(2,:),'b','linewidth',3)

set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0.005 0.045],'ytick',0.01:0.01:0.08,'linewidth',3);
set (gca,'FontSize',16,'fontweight','bold','fontname','arial black')
...
%% Plot GC- time frequency domain at 10 Hz    O -----> F
clear all
clc
load Granger_tf_100+400+50

figure,clf
set (gcf,'color','w')
value = spcrv([time2save;squeeze(nanmean(tf_granger1(1,:,:),3))]); % smooth the line----function 'spcrv'
plot(value(1,:),value(2,:),'.-','color',[0.6 0.6 0.6],'linewidth',3)
hold on
value = spcrv([time2save;squeeze(nanmean(tf_granger2(1,:,:),3))]);
plot(value(1,:),value(2,:),'.-k','linewidth',3)

set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0 0.04],'ytick',0:0.01:0.04,'linewidth',3);
set (gca,'FontSize',16,'fontweight','bold','fontname','arial black')
% title('Neutral','FontSize',18,'fontweight','bold','fontname','arial black')

figure,clf
set (gcf,'color','w')
 value = spcrv([time2save;squeeze(nanmean(tf_granger3(1,:,:),3))]);
plot(value(1,:),value(2,:),'-b','linewidth',3)
hold on
 value = spcrv([time2save;squeeze(nanmean(tf_granger4(1,:,:),3))]);
plot(value(1,:),value(2,:),'-r','linewidth',3)
set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0 0.04],'ytick',0:0.01:0.04,'linewidth',3);
set (gca,'FontSize',16,'fontweight','bold','fontname','arial black')
...
figure,clf
set (gcf,'color','w')
 value = spcrv([time2save;squeeze(nanmean(tf_granger_d(1,:,:),3))]);
plot(value(1,:),value(2,:),'-k','linewidth',3)
hold on
 value = spcrv([time2save;squeeze(nanmean(tf_granger_s(1,:,:),3))]);
plot(value(1,:),value(2,:),'-','color',[0.6 0.6 0.6],'linewidth',3)
set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0 0.04],'ytick',0:0.01:0.04,'linewidth',3);
set (gca,'FontSize',16,'fontweight','bold','fontname','arial black')
...
%% Plot GC-time frequncy domain at 10 Hz    F ---> O
...
figure,clf
set (gcf,'color','w')
value = spcrv([time2save;squeeze(nanmean(tf_granger1(2,:,:),3))]); % smooth the line----function 'spcrv'
plot(value(1,:),value(2,:),'.-','color',[0.6 0.6 0.6],'linewidth',3)
hold on
value = spcrv([time2save;squeeze(nanmean(tf_granger2(2,:,:),3))]);
plot(value(1,:),value(2,:),'.-k','linewidth',3)
...
figure,clf
set (gcf,'color','w')
 value = spcrv([time2save;squeeze(nanmean(tf_granger3(2,:,:),3))]);
plot(value(1,:),value(2,:),'-b','linewidth',3)
hold on
 value = spcrv([time2save;squeeze(nanmean(tf_granger4(2,:,:),3))]);
plot(value(1,:),value(2,:),'-r','linewidth',3)
set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0 0.04],'ytick',0:0.01:0.04,'linewidth',3);
set (gca,'FontSize',16,'fontweight','bold','fontname','arial black')
% title('Happy','FontSize',18,'fontweight','bold','fontname','arial black')
...
figure,clf
set (gcf,'color','w')
 value = spcrv([time2save;squeeze(nanmean(tf_granger_d(2,:,:),3))]);
plot(value(1,:),value(2,:),'-k','linewidth',3)
hold on
 value = spcrv([time2save;squeeze(nanmean(tf_granger_s(2,:,:),3))]);
plot(value(1,:),value(2,:),'-','color',[0.6 0.6 0.6],'linewidth',3)
set (gca,'xlim',[-200 2100],'xtick',0:500:2000,'ylim',[0 0.04],'ytick',0:0.01:0.04,'linewidth',3);
set (gca,'FontSize',16,'fontweight','bold','fontname','arial black')
% title('N2H','FontSize',18,'fontweight','bold','fontname','arial black')
